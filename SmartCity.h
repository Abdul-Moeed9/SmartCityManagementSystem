...
private:
    ...
    void transportMenu() {
        ...
        cout << "18. Back to main menu" << endl;
        cout << "========================================" << endl;
    ...
    void loadSectorsData() {
        ...
        for (int i = 0; i < educationSector->GetSchoolCount(); i++) {
            ...
            transportSector->addStop(stopId, stopName, school->GetLatitude(), school->GetLongitude());
        }
        ...
        for (int i = 0; i < keyCount; i++) {
            ...
            transportSector->addStop(stopId, stopName, hospital->latitude, hospital->longitude);
        }
