...
public:
    ...
    void displayProductsInMall(const string& mallid) {
        ...
        cout << "\nProducts in The Mall: " << mall->name << endl;
        ...
        while (temp) {
            ...
            if (p) {
                cout << "\n" << idx << ". " << p->name << " | Category: " << p->category
    ...
    void SearchProductByName(string name) {
        ...
        while (temp) {
            ...
            if (prod) {
                cout << "\n " << count++ << ". Available at: " << prod->mallName << endl;
    ...
    void searchByCategory(string category) {
        ...
        if (!products || products->isEmpty()) {
            cout << "\nNo products in category: " << category << endl;
            return;
        }
    ...
    void addMall() {
        ...
        for (int i = 0; i < existingCount; i++) {
            if (existingKeys[i] != id) {
                ...
                if (existingMall) {
                    double dist = MathUtils::calculateDistance(lat, lon, existingMall->latitude, existingMall->longitude);
                    if (dist > 0 && dist < 50.0) {
        ...
        delete[] existingKeys;
        cout << endl << "Mall added successfully! Total malls: " << mallCount << endl;
    }
